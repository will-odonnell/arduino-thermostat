...
void loop() {
  ...
  if (Serial.available() > 0) {
    ...
    switch (incomingByte) {
      ...
      // Adjust Air Flow
      case 'a':
        airflow.write(AIR_10_PCT);
        air = 10;
      break;

      case 'b':
        airflow.write(AIR_25_PCT);
        air = 25;
      break;

      case 'c':
        airflow.write(AIR_50_PCT);
        air = 50;
      break;

      case 'd':
        airflow.write(AIR_75_PCT);
        air = 75;
      break;

      case 'e':
        airflow.write(AIR_100_PCT);
        air = 99;
      break;

      case 'x':
        while (Serial.available() == 0)
//          targetTempHigh = Serial.read();
//          targetTempLow  = Serial.read();
targetTempHigh = 0x37;
targetTempLow  = 0x33;
      break;
      ...
      case 'y':
        while (Serial.available() == 0)
          currentTempHigh = Serial.read();
          currentTempLow  = Serial.read();
      break;
...
//      delay(100);
    ...
    Serial2.write(0x80);
    Serial2.print("Airflow:");
    Serial2.println(air, DEC);

    Serial2.write(0x94);
    Serial2.print("Temp:");
    Serial2.print(currentTempHigh);
    Serial2.print(currentTempLow);
    
    Serial2.write(0x9D);
    Serial2.print("Trg:");
    Serial2.write(targetTempHigh);
    Serial2.write(targetTempLow);
  }

//  Serial1.write("trg temp = "); Serial1.write(targetTemp);
//  Serial1.write("cur temp = "); Serial1.write(currentTemp);
//  Serial1.write("\r");
